This appendix shows one way to install a rudimentary Ceph cluster with Juju backed by an AWS cloud. See [Ceph documentation](http://docs.ceph.com/docs) to find out more about Ceph.
