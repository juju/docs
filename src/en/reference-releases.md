...
1.26-alpha2 is currently in development for testing.
The previous development release was 1.26-alpha1.
...
Centos
: [juju-1.26-alpha2-centos7.tar.gz](https://launchpad.net/juju-core/1.26/1.26-alpha2/+download/juju-1.26-alpha2-centos7.tar.gz) ([md5](https://launchpad.net/juju-core/1.26/1.26-alpha2/+download/juju-1.26-alpha2-centos7.tar.gz/+md5))
{: .instruction }

OS X
: [juju-1.26-alpha2-osx.tar.gz](https://launchpad.net/juju-core/1.26/1.26-alpha2/+download/juju-1.26-alpha2-osx.tar.gz) ([md5](https://launchpad.net/juju-core/1.26/1.26-alpha2/+download/juju-1.26-alpha2-osx.tar.gz/+md5))
{: .instruction }

Windows
: [juju-setup-1.26-alpha2.exe](https://launchpad.net/juju-core/1.26/1.26-alpha2/+download/juju-setup-1.26-alpha2.exe) ([md5](https://launchpad.net/juju-core/1.26/1.26-alpha2/+download/juju-setup-1.26-alpha2.exe/+md5))
{: .instruction }
