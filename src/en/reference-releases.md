...
Current development version is 2.2-beta2.
...
CentOS:
: [juju-core_2.2-beta2-centos7.tar.gz](https://launchpad.net/juju/2.2/2.2-beta2/+download/juju-2.2-beta2-centos7.tar.gz) ([md5](https://launchpad.net/juju/2.2/2.2-beta2/+download/juju-2.2-beta2-centos7.tar.gz/+md5))
{: .instruction }

Windows:
: [juju-setup-2.2-beta2.exe](https://launchpad.net/juju/2.2/2.2-beta2/+download/juju-setup-2.2-beta2.exe) ([md5](https://launchpad.net/juju/2.2/2.2-beta2/+download/juju-setup-2.2-beta2.exe/+md5))
{: .instruction }

MacOS:
: [juju-core_2.2-beta2-osx.tar.gz](https://launchpad.net/juju/2.2/2.2-beta2/+download/juju-2.2-beta2-osx.tar.gz) ([md5](https://launchpad.net/juju/2.2/2.2-beta2/+download/juju-2.2-beta2-osx.tar.gz/+md5))
{: .instruction }
