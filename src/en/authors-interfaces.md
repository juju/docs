...
The `provides` and `requires` keys defined in [metadata.yaml](./authors-charm-metdata)
are used to define pairings of charms that are likely to be fruitful. Consider
mongodb's metadata:
