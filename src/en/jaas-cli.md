...
^# For Windows
   ...
   [juju-setup-2.2.0.exe](https://launchpad.net/juju/2.2/2.0.0/+download/juju-setup-2.2.0.exe)([md5](https://launchpad.net/juju/2.2/2.2.0/+download/juju-setup-2.2.0.exe/+md5))
