...
The most recent stable version of Juju is 2.3.7. This is the version we
...
[**juju-2.3.7-centos7.tar.gz**][juju-centos] ([md5][juju-centos-md5])
...
[**juju-setup-2.3.7-signed.exe**][juju-win-signed] ([md5][juju-win-signed-md5])
...
[juju-win-signed]: https://launchpad.net/juju/2.3/2.3.7/+download/juju-setup-2.3.7-signed.exe
[juju-win-signed-md5]: https://launchpad.net/juju/2.3/2.3.7/+download/juju-setup-2.3.7-signed.exe/+md5
[juju-centos]: https://launchpad.net/juju/2.3/2.3.7/+download/juju-2.3.7-centos7.tar.gz
[juju-centos-md5]: https://launchpad.net/juju/2.3/2.3.7/+download/juju-2.3.7-centos7.tar.gz/+md5
