...
The most recent stable version of Juju is 2.4.4. This is the version we
...
[**juju-2.4.4-centos7.tar.gz**][juju-centos] ([md5][juju-centos-md5])
...
[**juju-setup-2.4.4-signed.exe**][juju-win-signed] ([md5][juju-win-signed-md5])
...
[juju-win-signed]: https://launchpad.net/juju/2.4/2.4.4/+download/juju-setup-2.4.4-signed.exe
[juju-win-signed-md5]: https://launchpad.net/juju/2.4/2.4.4/+download/juju-setup-2.4.4-signed.exe/+md5
[juju-centos]: https://launchpad.net/juju/2.4/2.4.4/+download/juju-2.4.4-centos7.tar.gz
[juju-centos-md5]: https://launchpad.net/juju/2.4/2.4.4/+download/juju-2.4.4-centos7.tar.gz/+md5
