...
![create_gce_project_dropdown](https://assets.ubuntu.com/v1/43c3a760-config-gce-new_project_dropdown.png)

Enter a project name (here 'My Juju-GCE Project'):

![create_gce_project_details](https://assets.ubuntu.com/v1/93614440-config-gce-first_project_create.png)
...
![Product & services icon](https://assets.ubuntu.com/v1/c370ed85-config-gce-product_services_icon.png)

Click through and select 'API Manager'. By default you will be on the 'Overview'
screen, it will show this across the top:

![API Manager screen](https://assets.ubuntu.com/v1/6050984b-config-gce-api_manager.png)

Click '+Enable API' and then from the list of available APIs you are shown,
select 'Compute Engine API':

![Compute Engine API](https://assets.ubuntu.com/v1/0054febd-config-gce-api_manager_compute_enabled.png)
...
![Create credentials dialog #1](https://assets.ubuntu.com/v1/903869a3-config-gce-api_manager_create_credentials-1.png)

In the ensuing dialog, select 'Compute Engine default service account' and 'JSON'
key type:

![Create credentials dialog #2](https://assets.ubuntu.com/v1/bea196d6-config-gce-api_manager_create_credentials-2.png)
