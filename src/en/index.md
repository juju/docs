    ...
    <div class="p-content__row">
        <div class="u-equal-height">
            <div class="col-6">
                ...
                <p><a href="/2.3/en/getting-started">Getting started with Juju&nbsp;&rsaquo;</a></p>
            </div>
        ...
        <div class="u-equal-height">
            ...
            <div class="col-6">
                <h2>Explore Juju</h2>
                <ul class="p-list">
                    <li class="p-list__item"><a href="/2.3/en/reference-install">Install Juju&nbsp;&rsaquo;</a></li>
                    <li class="p-list__item"><a href="/2.3/en/juju-concepts">Concepts and terms&nbsp;&rsaquo;</a></li>
                    <li class="p-list__item"><a href="/2.3/en/tut-google">Working with controllers and models&nbsp;&rsaquo;</a></li>
                    <li class="p-list__item"><a href="/2.3/en/tut-users">Working with users&nbsp;&rsaquo;</a></li>
                </ul>
            </div>
        </div>
        <hr class="is-deep">
        <div class="u-equal-height">
            ...
            <div class="col-6">
                ...
                <ul class="p-list">
                    ...
                    <li class="p-list__item--deep"><a class="p-link--external" href="/2.3/en/contributing">Help improve the documentation</a></li>
                </ul>
            </div>
        </div>
    </div>
