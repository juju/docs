...
With the aid of the `--no-download` option a local backup can be prevented.
...
The first line shows the remote backup and the second line shows the local
backup. From the name of the remote archive we see that the backup was made on
May 15, 2018 at 19:19:42 UTC.
