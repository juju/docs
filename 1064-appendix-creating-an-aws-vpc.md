This appendix is in connection with [Juju and Fan networking](/t/fan-container-networking/1065) where an AWS user may wish to create an additional VPC (virtual private network).
