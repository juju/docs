...
> See also: {ref}`remove-storage-pool <command-juju-remove-storage-pool>`, {ref}`update-storage-pool <command-juju-update-storage-pool>`, {ref}`storage-pools <command-juju-storage-pools>`
