tmihoc | 2024-03-26 10:28:29 UTC | #1

> <small> [Bundle](/t/5645) > File `<bundle>.yaml`</small>
>
...
----
[details=Example base and overlay in the same file]
``` yaml
applications:
  mysql:
    charm: "mysql"
...
[details=Example `<bundle>.yaml` file -- Kubernetes]
...
[details=Example `<bundle>.yaml` file -- machines]
...
pedroleaoc | 2022-04-07 08:33:13 UTC | #2
...
bager077 | 2023-10-18 16:36:50 UTC | #4
