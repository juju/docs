jnsgruk | 2022-01-24 15:12:59 UTC | #1
...
> See also:
> - [About the README file](/t/4454#heading--readme)
...
mthaddon | 2021-04-17 07:04:17 UTC | #2

[quote="jnsgruk, post:1, topic:4463"]
An example of this can be seen on the Mattermost [charm page](https://charmhub.io/discourse/docs).
[/quote]

Should this link be `https://charmhub.io/mattermost-charmers-mattermost/docs` or should it be `https://charmhub.io/discourse-charmers-discourse-k8s/docs` and say "Discourse" rather than "Mattermost"?

-------------------------

jnsgruk | 2021-04-19 07:42:51 UTC | #3

The former; thank you! Fixed!

-------------------------

pedroleaoc | 2021-06-08 18:06:51 UTC | #4
