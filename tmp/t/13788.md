tmihoc | 2024-08-06 13:49:50 UTC | #1

> See also: [Extension](/t/15011)
...
> See more: [Rockcraft | `rockcraft list-extensions`](https://canonical-rockcraft.readthedocs-hosted.com/en/latest/reference/commands/list-extensions/), [`charmcraft list-extensions`](/t/13780)
...
----
[details=See effect given sample context]
```
$ CHARMCRAFT_ENABLE_EXPERIMENTAL_EXTENSIONS=1 charmcraft expand-extensions
...
> See more: [`rockcraft expand-extensions`](https://canonical-rockcraft.readthedocs-hosted.com/en/latest/reference/commands/expand-extensions/), [`charmcraft expand-extensions`](/t/13779)
