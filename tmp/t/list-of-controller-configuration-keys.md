...
> <small> {ref}`Configuration <configuration>` > List of controller configuration keys</small>
>
> See also: {ref}`Controller <controller>`,  {ref}`How to manage configuration values for a controller <7059md>`

- [`agent-logfile-max-backups`](#heading--agent-logfile-max-backups)
- [`agent-logfile-max-size`](#heading--agent-logfile-max-size)
- [`agent-ratelimit-max`](#heading--agent-ratelimit-max)
- [`agent-ratelimit-rate`](#heading--agent-ratelimit-rate)
- [`allow-model-access`](#heading--allow-model-access)
- [`api-port`](#heading--api-port)
- [`api-port-open-delay`](#heading--api-port-open-delay)
- [`application-resource-download-limit`](#heading--application-resource-download-limit)
- [`audit-log-capture-args`](#heading--audit-log-capture-args)
- [`audit-log-exclude-methods`](#heading--audit-log-exclude-methods)
- [`audit-log-max-backups`](#heading--audit-log-max-backups)
- [`audit-log-max-size`](#heading--audit-log-max-size)
- [`auditing-enabled`](#heading--auditing-enabled)
- [`autocert-dns-name`](#heading--autocert-dns-name)
- [`autocert-url`](#heading--autocert-url)
- [`ca-cert`](#heading--ca-cert)
- [`caas-image-repo`](#heading--caas-image-repo)
- [`caas-operator-image-path`](#heading--caas-operator-image-path)
- [`controller-api-port`](#heading--controller-api-port)
- [`controller-name`](#heading--controller-name)
- [`controller-resource-download-limit`](#heading--controller-resource-download-limit)
- [`controller-uuid`](#heading--controller-uuid)
- [`features`](#heading--features)
- [`identity-public-key`](#heading--identity-public-key)
- [`identity-url`](#heading--identity-url)
- [`juju-db-snap-channel`](#heading--juju-db-snap-channel)
- [`juju-ha-space`](#heading--juju-ha-space)
- [`juju-mgmt-space`](#heading--juju-mgmt-space)
- [`jujud-controller-snap-source`](#heading--jujud-controller-snap-source)
- [`login-token-refresh-url`](#heading--login-token-refresh-url)
- [`max-agent-state-size`](#heading--max-agent-state-size)
- [`max-charm-state-size`](#heading--max-charm-state-size)
- [`max-debug-log-duration`](#heading--max-debug-log-duration)
- [`max-prune-txn-batch-size`](#heading--max-prune-txn-batch-size)
- [`max-prune-txn-passes`](#heading--max-prune-txn-passes)
- [`max-txn-log-size`](#heading--max-txn-log-size)
- [`metering-url`](#heading--metering-url)
- [`migration-agent-wait-time`](#heading--migration-agent-wait-time)
- [`model-logfile-max-backups`](#heading--model-logfile-max-backups)
- [`model-logfile-max-size`](#heading--model-logfile-max-size)
- [`model-logs-size`](#heading--model-logs-size)
- [`mongo-memory-profile`](#heading--mongo-memory-profile)
- [`prune-txn-query-count`](#heading--prune-txn-query-count)
- [`prune-txn-sleep-time`](#heading--prune-txn-sleep-time)
- [`public-dns-address`](#heading--public-dns-address)
- [`query-tracing-enabled`](#heading--query-tracing-enabled)
- [`query-tracing-threshold`](#heading--query-tracing-threshold)
- [`set-numa-control-policy`](#heading--set-numa-control-policy)
- [`state-port`](#heading--state-port)
...
<a href="#heading--metering-url"><h2 id="heading--metering-url"><code>metering-url</code></h2></a>
...
<a href="#heading--model-logs-size"><h2 id="heading--model-logs-size"><code>model-logs-size</code></h2></a>
