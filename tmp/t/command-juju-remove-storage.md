...
> See also: {ref}`add-storage <command-juju-add-storage>`, {ref}`attach-storage <command-juju-attach-storage>`, {ref}`detach-storage <command-juju-detach-storage>`, {ref}`list-storage <command-juju-list-storage>`, {ref}`show-storage <command-juju-show-storage>`, {ref}`storage <command-juju-storage>`
