econley | 2024-10-18 15:10:48 UTC | #1

The `django-framework` Charmcraft [extension](/t/15011) includes configuration options customised for a Django application. This document describes all the keys that a user may interact with.
...
----
[details=Expand to view pre-loaded integrations]
```text
peers:
  secret-storage:
