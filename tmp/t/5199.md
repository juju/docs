...
0x12b | 2022-01-26 13:08:25 UTC | #2

Updated article to reflect the renaming of LMA Light to COS Lite

-------------------------

pedroleaoc | 2022-04-07 08:33:19 UTC | #3



-------------------------

chrome0 | 2022-09-08 09:54:19 UTC | #4

The instructions say to enable the metallb addon, so the dashboards should actually also be available externally under the host ipaddr due to the traefik ingress installed, eg. something like http://$IPADDR/cos-prometheus-0/graph for prometheus. Might make sense to mention this here as well

-------------------------

sed-i | 2022-09-08 11:29:55 UTC | #5

Thanks @chrome0, that's a good idea.

After [grafana ingress](https://github.com/canonical/grafana-k8s-operator/pull/117) merges I plan to go over the tutorial again.

cc: @0x12b

-------------------------

pedroleaoc | 2022-10-14 11:30:14 UTC | #6



-------------------------

taurus | 2023-04-17 15:37:21 UTC | #7

Hi,

First of all, it is a nice How-To!

Please consider to improve section "Browse dashboards" by mentioning action `get-admin-password` to retrieve the admin password. It took me a while to guess the proper username and password to login Grafana WEB interface. :slight_smile: 

For the history. The username is `admin`, password is automatically generated for every installation:
...
sed-i | 2023-04-17 16:24:34 UTC | #8

Thanks @taurus! Updated.

-------------------------

bcarbone | 2023-04-17 16:45:04 UTC | #9

Hey, just ran into this too, trying to figure out what the URL should be when using metallb ;).
Figured it out, but would be nice to have the info in the docs.

-------------------------

sed-i | 2023-04-17 19:45:21 UTC | #10

Thanks for the reminded @bcarbone, updated!

-------------------------

evilnick | 2023-05-16 11:47:36 UTC | #11

Hi, i just added a few tweaks, primarily because moving forward you will no longer be able to enable multiple MicroK8s addons in a single line

-------------------------

gbeuzeboc | 2023-08-18 08:29:14 UTC | #12

It seems that the command `juju run-action` no longer exist in the current version of juju.
Replacing it with `juju run` seems to work.
Example:
```
...
sed-i | 2023-08-18 17:57:04 UTC | #13

Thanks @gbeuzeboc, updated!

-------------------------

taurus | 2023-08-24 10:13:44 UTC | #14

Please consider to remove `--wait` here (Juju 3.1.5):
```
> juju run grafana/leader get-admin-password --model cos --wait
ERROR option needs an argument: --wait
```
The command works well without it.

-------------------------

sed-i | 2023-08-28 16:10:27 UTC | #15
