...
1. [Add a Kubernetes service port to your charm](#heading--add-a-kubernetes-service-port-to-your-charm)
1. [Test the new feature](#heading--test-the-new-feature)
1. [Validate your charm](#heading--validate-your-charm)
1. [Review the final code](#heading--review-the-final-code)

<a href="#heading--add-a-kubernetes-service-port-to-your-charm"><h2 id="heading--add-a-kubernetes-service-port-to-your-charm">Add a Kubernetes service port to your charm</h2></a>
...
<a href="#heading--test-the-new-feature"><h2 id="heading--test-the-new-feature">Test the new feature</h2></a>

- [Write a unit test](#heading--write-a-unit-test)
- [Write a scenario test](#heading--write-a-scenario-test)
- [Write an integration test](#heading--write-an-integration-test)

<a href="#heading--write-a-unit-test"><h3 id="heading--write-a-unit-test">Write a unit test</h3></a>
...
<a href="#heading--write-a-scenario-test"><h3 id="heading--write-a-scenario-test">Write a scenario test</h3></a>
...
<a href="#heading--write-an-integration-test"><h3 id="heading--write-an-integration-test">Write an integration test</h3></a>
...
> <small>Contributors: @adithya-raj, @mmkay  @ibraaoad, @tmihoc, @james-garner </small>