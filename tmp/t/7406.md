beliaev-maksim | 2024-03-26 03:37:28 UTC | #1

> <small> [From Zero to Hero: Write your first Kubernetes charm](/t/7113) > Expose the version of the application behind your charm </small>
>
> **See previous: [Make your charm configurable](/t/7401)** 
...
> **See next: [Integrate your charm with PostgreSQL](/t/7414)**

> <small> Contributors: @beliaev-maksim </small>

-------------------------

beliaev-maksim | 2022-11-14 11:45:03 UTC | #2



-------------------------

beliaev-maksim | 2023-01-31 16:49:01 UTC | #3



-------------------------

spyrosv | 2023-06-30 19:15:40 UTC | #4

Hello!

A **minor** correction, the version of the [api_demo_server](https://github.com/canonical/api_demo_server/blob/master/api_demo_server/__init__.py)  is now `1.0.0` instead of  `0.0.9`. 

So the `Version` in the `juju status` output is affected.

-------------------------

gu1nn3zz | 2024-07-12 09:04:25 UTC | #5

[quote="beliaev-maksim, post:1, topic:7406"]
## [Review the final code](#heading--review-the-final-code)

For the full code see: [03_set_workload_version ](https://github.com/canonical/juju-sdk-tutorial-k8s/tree/03_set_workload_version)
[/quote]

This link is dead because the branch does not exist (anymore ?)

-------------------------

beliaev-maksim | 2024-07-13 20:54:16 UTC | #6

@tony-meyer you deleted the branch here, I restored. Please check other branches

https://github.com/canonical/juju-sdk-tutorial-k8s/pull/38
