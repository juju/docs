beliaev-maksim | 2024-09-11 04:58:53 UTC | #1

> <small> [From Zero to Hero: Write your first Kubernetes charm](/t/7113) > Make your charm configurable</small>
>
> **See previous: [Create a minimal Kubernetes charm](/t/7388)** 
...
> Read more: [How to make your charm configurable](/t/4458)
...
> Read more: [`options`](/t/7132#heading--config)
...
> **See next: [Expose the version of the application behind your charm](/t/7406)**

> <small> Contributors: @beliaev-maksim, @tony-meyer, @tmihoc, @james-garner </small>

-------------------------

beliaev-maksim | 2022-11-11 16:40:59 UTC | #2



-------------------------

beliaev-maksim | 2023-01-31 16:49:07 UTC | #3



-------------------------

bittner | 2023-06-13 18:02:25 UTC | #4

[quote="beliaev-maksim, post:1, topic:7401"]
You should see JSON string
[/quote]
...
(Can we contribute to this content directly, somehow, like in the Juju docs?)

-------------------------

mylesjp | 2024-04-05 20:41:02 UTC | #5

Since Charmcraft 2.5 has all charm information in `charmcraft.yaml`, the following should be updated to replace `metadata.yaml` with `charmcraft.yaml`.
> 
> ```
