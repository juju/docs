tmihoc | 2024-03-04 08:26:03 UTC | #1

> See also: [How to manage credentials](/t/1112)

In Juju, a **credential** represents a collection of authentication material (like username & password, or client id & secret key) that is specific to a Juju [user](/t/6186) and a [cloud](/t/5454) and allows that user to interact with that cloud. 
...
When you create a  [model](/t/5456) in Juju it must always be associated with a cloud/credential pair -- the model needs that to create resources on the underlying cloud. 
...
> See also: [How to add a credential](/t/1112#heading--add-a-credential)
...
---------
[details=Expand to view the schema all at once]
...
[/details]
------
[details=Expand to view an example of five credentials being stored against four clouds]
```text
credentials:
  aws:
    <credential>:
...
**Value:** Scalar denoting (one of) the authentication type(s) from your cloud definition. Cloud-specific. See more: [List of supported clouds > `<cloud>`](/t/6665).
...
**Purpose:** Holds information associated with a particular attribute of the authentication type (e.g., `subscription-id`). Authentication-type-specific. See more: [List of supported clouds > `<cloud>`](/t/6665).
...
pedroleaoc | 2022-10-14 11:31:03 UTC | #3
