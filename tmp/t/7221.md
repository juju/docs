ppasotti | 2024-05-02 17:46:48 UTC | #1
...
ppasotti | 2022-10-18 10:03:41 UTC | #2



-------------------------

ppasotti | 2022-10-27 12:15:14 UTC | #3

Thanks for the edit @tmihoc, looking much better now!
We might want to align with the rest of the team on this, but I believe the official terminology has evolved: not `holder` but `consumer`.  After confirming with the leads we'll need to replace.

-------------------------

tmihoc | 2022-10-27 12:16:13 UTC | #4

Sounds good -- let me know when it's confirmed!

-------------------------

ppasotti | 2022-10-31 09:23:17 UTC | #5

confirmed! We just decided to go to **consumer**. Will adapt it in the other docs.

-------------------------

mthaddon | 2022-11-09 11:00:21 UTC | #6
...
ppasotti | 2022-11-09 11:46:16 UTC | #7

looking into it. I think it must be something with ops, because secret-get from the unit appears to succeed

-------------------------

ppasotti | 2022-11-09 11:54:00 UTC | #8

![image|672x184](upload://xgt7GJfKXLxtOBbLkX78wjXwUCB.png) 
It seems that the secret is there allright, but we can't get the metadata and don't know how to recover from that. I think with peer-scoped secrets there might be some subtlety we didn't cater for yet in `ops`, we expect owner and consumer to be distinct entities but in this case the charm is both, however the follower unit does not have metadata access because it doesn't have leadership.

Will look into this next week. @wallyworld thoughts on this?

-------------------------

wallyworld | 2022-11-09 23:59:53 UTC | #9

Only the secret owner can ask for metadata, ie for application owned secrets, this is the leader unit.
All peer units can read the content of application secrets, but only leaders can access metadata.

-------------------------

benhoyt | 2023-01-08 21:34:23 UTC | #10
