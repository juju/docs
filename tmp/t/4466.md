jnsgruk | 2024-04-25 13:52:25 UTC | #1
...
pedroleaoc | 2021-06-08 18:06:22 UTC | #2



-------------------------

kos.tsakalozos | 2021-06-23 18:59:06 UTC | #3

How can I mount a directory from the host into a pod? Looking for somethig similar to hostpath.

-------------------------

jnsgruk | 2021-06-23 19:23:00 UTC | #4

Hey, I don't *think* you can do this, but @jameinel or @manadart may have a better answer here :slight_smile:

-------------------------

sed-i | 2022-06-22 06:02:28 UTC | #5

[quote="jnsgruk, post:1, topic:4466"]
|Field|Type|Default|Description
|------|-----|-----|-----|
|`minimum-size`|`string`|`1GiB`|Size in the forms: `1.0G`, `1GiB`, `1.0GB`. Supported size multipliers are `M`, `G`, `T`, `P`, `E`, `Z`, `Y`. Not specifying a multiplier implies `M`.
[/quote]
