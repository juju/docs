econley | 2024-10-17 13:56:32 UTC | #1

The `fastapi-framework` Charmcraft [extension](/t/15011) includes configuration options customised for a FastAPI application. This document describes all the keys that a user may interact with.
