timClicks | 2024-02-19 12:10:11 UTC | #1

> See also:  [Plugin](/t/1145)
...
- adding your plugin to our [list](/t/5202) of third-party Juju plugins.
...
- Submit a pull request to have it included in the [plugins Github repository](https://github.com/juju/plugins). Also add it to the [List of known `juju` plugins](/t/5202).
...
crucible | 2024-10-04 15:35:05 UTC | #4

Please see [this issue](https://github.com/juju/docs/issues/3520) regarding this doc.
