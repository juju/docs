...
> See also: {ref}`Juju Dashboard <the-juju-dashboard>`, [Charmhub | `juju-dashboard`](https://charmhub.io/juju-dashboard)
...
> See more: {ref}``juju dashboard` <command-juju-dashboard>`
...
```text
juju refresh {ref}`dashboard-app-name]
```
...
> See more: [`juju refresh` <command-juju-refresh>`
