system | 2024-09-16 15:55:56 UTC | #1
...
> See also: [consume](/t/10213), [find-offers](/t/10097), [set-firewall-rule](/t/10151), [suspend-relation](/t/10179)
...
javierdelapuente | 2024-06-28 10:25:52 UTC | #2

[quote="system, post:1, topic:10207"]
`juju integrate [options] <application>[:<relation>] <application>[:<relation>]`
[/quote]

Later in the document, instead or `relation`, it is used `endpoint` like: `
juju integrate <application>[:<endpoint>] <application>[:<endpoint>]
`
I think only one name should be used.
