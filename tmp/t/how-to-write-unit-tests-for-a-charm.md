...
**Contents:**
- [Testing basics](#heading--testing-basics)
- [Testing log output](#heading--testing-log-output)
- [Simulating container networking](#heading--simulate-can-connect)

 <a href="#heading--testing-basics"><h2 id="heading--testing-basics">Testing basics</h2></a>
...
testing pebble events and sidecar container interactions, etc.).
 ...
 <a href="#heading--testing-log-output"><h2 id="heading--testing-log-output">Testing log output</h2></a>
...
<a href="#heading--simulate-can-connect"><h2 id="heading--simulate-can-connect">Simulating Container Networking</h2></a>

[note status="version"]Initially in 1.4, changed in version 2.0[/note]
...
> <small>**Contributors:** @abatisse, @jnsgruk , @lengau, @pengale, @rwcarlsen , @tony-meyer, @tmihoc </small>