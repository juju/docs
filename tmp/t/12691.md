ppasotti | 2024-01-30 11:51:43 UTC | #1
...
Interface specifications, stored in [charm-relation-interfaces](/t/12659), are contract definitions that mandate how a charm should behave when integrated with another charm over a registered interface.
...
An interface test is a contract test powered by [`Scenario`](/t/10583) and a pytest plugin called [`pytest-interface-tester`](https://github.com/canonical/pytest-interface-tester). An interface test has the following pattern: 
