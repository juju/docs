tmihoc | 2024-02-01 07:48:45 UTC | #1

**Pebble** is a lightweight, API-driven process supervisor. In the charm SDK, it is used through [Ops](/t/5527) ([`ops.pebble.Client`](/t/6366)) to give workload containers something akin to an `init` system that will allow the charm container to interact with them. 
...
> See also: [How to use custom notices from the workload container](/t/4554#heading--use-custom-notices-from-the-workload-container)
