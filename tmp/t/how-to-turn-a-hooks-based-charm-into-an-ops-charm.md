...
> - {ref}`Hook <hook>`
> - {ref}`Ops <ops-ops>`
> - {ref}`Charm types <charm-taxonomy>`
> - {ref}`Charming history <about-charming-history>`
...
- [Analyse the charm](#heading--analyse-the-charm)
    - [Setting up the stage](#heading--setting-up-the-stage)
    - [The plan](#heading--the-plan)
- [Detour: Lazy approach](#heading--detour-lazy-approach)
    - [Step 1: move script contents as-they-are into dedicated charm methods](#heading--step-1-move-script-contents-as-they-are-into-dedicated-charm-methods)
        - [Wrapping the `website` relation](#heading--wrapping-the-website-relation)
        - [Logging](#heading--logging)
        - [Environment variables](#heading--environment-variables)
    - [Step 2: clean up snap & systemd code](#heading--step-2-clean-up-snap--systemd-code)
- [Closing notes](#heading--closing-notes)
    - [Todo's / disclaimers](#heading--todos--disclaimers)
 
<a href="#heading--analyse-the-charm"><h2 id="heading--analyse-the-charm">Analyse the charm</h2></a>
...
<a href="#heading--setting-up-the-stage"><h3 id="heading--setting-up-the-stage">Setting up the stage</h3></a>
...
<a href="#heading--the-plan"><h3 id="heading--the-plan">The plan</h3></a>

```{dropdown} Detour: exploration of a bad idea.


<a href="#heading--detour-lazy-approach"><h2 id="heading--detour-lazy-approach">Detour: Lazy approach</h2></a>
...
<a href="#heading--step-1-move-script-contents-as-they-are-into-dedicated-charm-methods"><h3 id="heading--step-1-move-script-contents-as-they-are-into-dedicated-charm-methods">Step 1: move script contents as-they-are into dedicated charm methods</h3></a>
...
<a href="#heading--wrapping-the-website-relation"><h4 id="heading--wrapping-the-website-relation">Wrapping the `website` relation</h4></a>
...
<a href="#heading--logging"><h4 id="heading--logging">Logging</h4></a>
...
<a href="#heading--environment-variables"><h4 id="heading--environment-variables">Environment variables</h4></a>
...
<a href="#heading--step-2-clean-up-snap--systemd-code"><h3 id="heading--step-2-clean-up-snap--systemd-code">Step 2: clean up snap & systemd code</h3></a>
...
<a href="#heading--closing-notes"><h2 id="heading--closing-notes">Closing notes</h2></a>
...
<a href="#heading--todos--disclaimers"><h3 id="heading--todos--disclaimers">Todo's / disclaimers</h3></a>
