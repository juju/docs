...
> See also: {ref}`How to manage offers <how-to-manage-offers>`

In Juju, an **offer** represents an {ref}`application <application>` that has been made available for {ref}`cross-model integrations <relation-integration>`.
