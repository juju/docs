...
1. [Define the actions](#heading--define-the-actions)
1. [Define the action event handlers](#heading--define-the-action-event-handlers)
1. [Validate your charm](#heading--validate-your-charm)
1. [Review the final code](#heading--review-the-final-code)

<a href="#heading--define-the-actions"><h2 id="heading--define-the-actions">Define the actions</h2></a>
...
>  Read more: {ref}`File 'charmcraft.yaml' <7592md>`, {ref}`How to handle actions <how-to-add-an-action-to-a-charm>`

<a href="#heading--define-the-action-event-handlers"><h2 id="heading--define-the-action-event-handlers">Define the action event handlers</h2></a>
...
> Read more:  {ref}`Event `<action name>-action` <event-action-name-action>`  
...
> Read more:  [Juju | `juju run`](https://juju.is/docs/olm/juju-run)  
...
> <small> Contributors: @beliaev-maksim, @james-garner </small>