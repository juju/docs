tmihoc | 2024-09-10 08:09:46 UTC | #1
...
> See also: [How to write a unit test for a charm with Harness](/t/4461), [How to write a unit test for a charm with Scenario](/t/10585)
...
- [`ops.testing.Harness`](https://operator-framework.readthedocs.io/en/latest/#module-ops.testing) and/or [`ops-scenario`](/t/10583)
...
## Integration testing
> See also: [How to write integration tests for a charm](/t/12734)
...
- [`pytest`](https://pytest.org/) and/or [`unittest`](https://docs.python.org/3/library/unittest.html) and
- [`harness`](https://operator-framework.readthedocs.io/en/latest/#module-ops.testing) and/or [`scenario`]()
...
tmihoc | 2023-07-12 10:41:34 UTC | #2
