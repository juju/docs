...
> See more: 
> 
> - The troubleshooting box at the end of {ref}`How to manage controllers > Bootstrap <1187md>`
> - The troubleshooting box at the end of {ref}`How to manage models > Migrate <1187md>`
> - ...
...
> See more: {ref}``juju debug-log` <command-juju-debug-log>`, {ref}`How to manage logs > Stream the logs <1187md>`, {ref}`How to manage logs > View the log files <1187md>`, {ref}`Juju logs <log>`
...
> See more: {ref}``juju debug-hooks` <1187md>` , {ref}``juju resolved` <command-juju-resolved>`
