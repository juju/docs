...
- [Create a plugin](#heading--create-a-plugin)
- [Install and run a plugin](#heading--install-and-run-a-plugin)
- [Distribute a plugin](#heading--distribute-a-plugin)



<a href="#heading--create-a-plugin"><h2 id="heading--create-a-plugin">Create a plugin</h2></a>
...
<a href="#heading--install-and-run-a-plugin"><h2 id="heading--install-and-run-a-plugin">Install and run a plugin</h2></a>
...
<a href="#heading--distribute-a-plugin"><h2 id="heading--distribute-a-plugin">Distribute a plugin</h2></a>
...
> <small>**Contributors:** @barrettj12, @timclicks, @tmihoc </small>