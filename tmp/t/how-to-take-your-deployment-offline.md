...
2. Figure out the list of external services required for your deployment and set up proxies / local mirrors for them. Depending on whether your deployment is on machines or Kubernetes, and on a localhost cloud or not, and which one, these services may include:
    ...
    - a container image registry: 
        ...
        - {ref}`public.ecr.aws/juju <14367md>`
        - [https://ghcr.io/juju](https://ghcr.io/juju)
 
> See more: {ref}`Bootstrapping <bootstrapping>`, {ref}`Deploying <deploying>`
...
- {ref}``agent-metadata-url` <14367md>`
- {ref}``apt-ftp-proxy` <14367md>`
- {ref}``apt-http-proxy` <14367md>`
- {ref}``apt-https-proxy` <14367md>`
- {ref}``apt-mirror` <14367md>`
- {ref}``apt-no-proxy` <14367md>`
- {ref}``container-image-metadata-url` <14367md>`
- {ref}``ftp-proxy` <14367md>`
- {ref}``http-proxy` <14367md>`
- {ref}``https-proxy` <14367md>`
- {ref}``image-metadata-url` <14367md>`
- {ref}``juju-ftp-proxy` <14367md>`
- {ref}``juju-http-proxy` <14367md>`
- {ref}``juju-https-proxy` <14367md>`
- {ref}``juju-no-proxy` <14367md>`
- {ref}``no-proxy` <14367md>`
- {ref}``snap-http-proxy` <14367md>`
- {ref}``snap-https-proxy` <14367md>`
- {ref}``snap-store-assertions` <14367md>`
- {ref}``snap-store-proxy` <14367md>`
- {ref}``snap-store-proxy-url` <14367md>`
