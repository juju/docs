tmihoc | 2024-08-02 11:26:15 UTC | #1

> See also: [Unit](/t/5460)

This document demonstrates various operations that you can perform on a unit. 

[note type=information]
Units are also relevant when adding storage or scaling an application. See [How to manage storage](/t/5892) and [How to manage applications](/t/5476).
[/note]
...
[note type=information]
This is only true for machine deployments. For Kubernetes, see [How to control the number of units](/t/5891#heading--control-the-number-of-units).
[/note]
...
> See more: [`juju add-unit`](/t/10141)
...
> See more: [How to add a unit](/t/5891#heading--add-a-unit), [How to remove a unit](/t/5891#heading--remove-a-unit)
...
> See more: [`juju scale-application`](/t/10171)
...
> See more: [`juju show-unit`](/t/10239)
...
> See more: [`Unit` (module)](
https://pythonlibjuju.readthedocs.io/en/latest/narrative/unit.html), [Unit (methods)](https://pythonlibjuju.readthedocs.io/en/latest/api/juju.unit.html#juju.unit.Unit), [Unit.get_public_address()](https://pythonlibjuju.readthedocs.io/en/latest/api/juju.unit.html#juju.unit.Unit.get_public_address), [Unit.is_leader_from_status()](https://pythonlibjuju.readthedocs.io/en/latest/api/juju.unit.html#juju.unit.Unit.is_leader_from_status)
...
> See more: [`juju status`](/t/10173), [Unit status](https://juju.is/docs/juju/status#heading--unit-status)
...
```
> See more: [Unit status](https://juju.is/docs/juju/status#heading--unit-status), [`Unit` (module)](
https://pythonlibjuju.readthedocs.io/en/latest/narrative/unit.html), [Unit (methods)](https://pythonlibjuju.readthedocs.io/en/latest/api/juju.unit.html#juju.unit.Unit), [Unit.workload_status (field)](https://pythonlibjuju.readthedocs.io/en/latest/api/juju.unit.html#juju.unit.Unit.workload_status), [Unit.agent_status (field)](https://pythonlibjuju.readthedocs.io/en/latest/api/juju.unit.html#juju.unit.Unit.agent_status)
...
> See more: [`juju set-meter-status`](/t/10166)
...
> See more: [`juju resolved`](/t/10144)
...
> See more: [`Unit.resolved()`]([/t/10144](https://github.com/juju/juju/pull/17046))
...
[note type=information]
While this can be used for both machine and Kubernetes deployments, unless you care about which unit you're removing specifically, in Kubernetes you may also just run `juju scale-application <n>`, where `n` is less than the current number of units. See [How to control the number of units](/t/5891#heading--control-the-number-of-units).
[/note]
...
> See more: [`juju remove-unit`](/t/10125), [Removing things reference](/t/1063)
...
skourta | 2024-08-02 08:37:04 UTC | #4

[Doc Bug]
Typo in the add unit section in the info box:
- How to controller -> How to control

@tmihoc please let me know if you want me to edit the page directly or leave that to you.
Thank you.

-------------------------

tmihoc | 2024-08-02 11:26:40 UTC | #5
