...
> See also: {ref}`Juju Roadmap & Releases <roadmap--releases>`
...
> See more: {ref}`Upgrading things <upgrading-things>`, {ref}`Cross-version compatibility in Juju <cross-version-compatibility-in-juju>`, {ref}`Juju Roadmap & Releases <roadmap--releases>`, individual charm releases
...
> See more:
> 
> - {ref}`How to install and manage the client > Upgrade <7530md>`
> - {ref}`How to manage controllers > Upgrade <7530md>`
> - {ref}`How to manage models > Upgrade <how-to-manage-models>`
> - {ref}`How to manage applications > Upgrade <7530md>`
