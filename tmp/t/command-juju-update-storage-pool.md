...
> See also: {ref}`create-storage-pool <command-juju-create-storage-pool>`, {ref}`remove-storage-pool <command-juju-remove-storage-pool>`, {ref}`storage-pools <command-juju-storage-pools>`
