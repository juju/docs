...
> See also: [`juju deploy --channel`](https://juju.is/docs/olm/juju-deploy)
...
- [Components](#heading--components)
 ...
 <a href="#heading--components"><h2 id="heading--components">Components</h2></a>
...
- [Branch](#heading--branch)
 ...
 <a href="#heading--track"><h3 id="heading--track">Track</h3></a>

> See also: {ref}`How to create a track for your charm <how-to-create-a-track-for-your-charm>`
...
To ensure consistency between tracks of the same charm, tracks must comply with a [guardrail](#heading--track-guardrail).

<!--
 - [Track guardrail](#heading--track-guardrail)
-->

<a href="#heading--track-guardrail"><h4 id="heading--track-guardrail">Track guardrail</h4></a>
> See also: {ref}`How to request a track guardrail <6562md>`
...
-->
 ...
 <a href="#heading--risk"><h3 id="heading--risk">Risk</h3></a>
...
-   **edge**: The very latest version - expect bugs!
 ...
 <a href="#heading--branch"><h3 id="heading--branch">Branch</h3></a>
