jnsgruk | 2024-04-25 13:52:39 UTC | #1
...
pedroleaoc | 2021-06-08 18:07:00 UTC | #2



-------------------------

gabrielcocenza | 2022-03-08 19:00:08 UTC | #3
...
```python
        ...
        self.assertIn("failed opening port 27017", "".join(logs.output))
```
Reading the documentation about [assertLogs](https://docs.python.org/3/library/unittest.html#unittest.TestCase.assertLogs) they also check outside the context.

I think it would be good to change the [sdk-documentation](https://juju.is/docs/sdk/testing#heading--testing-log-output) to do the same and avoid this kind of issue for future travelers :slightly_smiling_face:

-------------------------

jnsgruk | 2022-03-08 21:16:34 UTC | #4

Nice catch, thanks. I think that's sorted now! :)

-------------------------

marcusboden | 2023-11-23 14:58:03 UTC | #5

HI, I'm trying to write some tests for a new charm but:


[quote="jnsgruk, post:1, topic:4461"]
When you run `charmcraft init`, the template charm it creates includes some sample tests, along with a means to run them (see the `run_tests` shell script) and provide a short report of unit test coverage.
[/quote]
...
jnsgruk | 2023-11-23 17:38:14 UTC | #6

Fair point! @tmihoc this might be worth revisiting since the templates have been updated :)

-------------------------

tmihoc | 2023-11-24 15:14:54 UTC | #7
