tmihoc | 2023-06-06 12:07:25 UTC | #1

> See also: [How to register, upload, publish, and release a charm](/t/4462)
...
Charm revisions are not published for anybody else until you release them into a [channel](/t/6562). Once you release them, though, users will be able to see them at `charmhub.io/<charm/channel>` or access them via `juju info <charm>` or `juju deploy <charm>`. 
