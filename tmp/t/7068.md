tmihoc | 2024-10-29 13:49:31 UTC | #1
...
> See [List of supported clouds > `<cloud name>` > Cloud > definition](/t/6665) or run `juju show-cloud <cloud> --include-config`.
...
<br><br>
A module represents a single component of Juju, e.g. a [worker](/t/11298). Generally, modules correspond one-to-one with Go packages in the Juju source tree. The module name is the value passed to `loggo.GetLogger` or `loggo.GetLoggerWithLabels`.
<br><br>
...
`snap-https-proxy*` is the snap-centric HTTPS proxy value. See [Offline mode strategies](/t/1071).
...
pedroleaoc | 2022-10-14 11:25:48 UTC | #2



-------------------------

pedroleaoc | 2022-10-14 11:27:58 UTC | #3



-------------------------

brian-murray | 2023-05-25 22:57:21 UTC | #4

The "How to configure a model" link points to documentation that does not exist.

-------------------------

tmihoc | 2023-05-26 18:36:08 UTC | #5

Fixed, thanks!

-------------------------

bcarbone | 2023-08-08 09:10:39 UTC | #6

the `logging-config` section title is not rendered as expected:

![image|690x218](upload://mo29qhSTzL4VMPPgtIkWyLUrqZA.png)

-------------------------

tmihoc | 2023-08-08 09:27:57 UTC | #7

Fixed, thanks!

-------------------------

holmanb | 2024-04-09 19:44:22 UTC | #8
...
That bug has been fixed, can we please update the docs?

-------------------------

tmihoc | 2024-04-10 13:05:33 UTC | #9

@holmanb Fixed, thanks! (PS Also added you as a contributor to the doc.)

-------------------------

bran-castillo | 2024-08-13 23:33:22 UTC | #10

Under section, [How to provide custom user data cloudinit](https://juju.is/docs/juju/list-of-model-configuration-keys#how-to), there is a mistyped command. Perhaps an artifact of Juju 2.X?
```
...
tmihoc | 2024-08-19 11:44:33 UTC | #11
