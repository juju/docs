...
> See also: {ref}`How to manage spaces <how-to-manage-spaces>`

<!--
> See also:
> - {ref}`Constraint <constraint>`, {ref}`Endpoint <endpoint>`,  {ref}`Binding <binding>`
> - {ref}``juju add-space` <1157md>`,  {ref}``juju move-to-space` <1157md>`, {ref}``juju reload-spaces` <1157md>`, {ref}``juju remove-space` <1157md>`, {ref}``juju rename-space` <1157md>`, {ref}``juju spaces` <1157md>`
-->
...
{ref}`quote="system, post:1, topic:1157"]
[application endpoint <1157md>`.
[/quote]
