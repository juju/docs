...
> Read more: {ref}`How to make your charm configurable <how-to-add-a-configuration-option-to-a-charm>`

**Contents:**

1. [Define the configuration options](#heading--define-the-configuration-options)
1. [Define the configuration event handlers](#heading--define-the-configuration-event-handlers)
1. [Validate your charm](#heading--validate-your-charm)
1. [Review the final code](#heading--review-the-final-code)


<a href="#heading--define-the-configuration-options"><h2 id="heading--define-the-configuration-options">Define the configuration options</h2></a>
...
> Read more: {ref}``options` <7401md>`

<a href="#heading--define-the-configuration-event-handlers"><h2 id="heading--define-the-configuration-event-handlers">Define the configuration event handlers</h2></a>
...
Read more: [Event 'config-changed'](https://juju.is/docs/sdk/config-changed-event)
...
> <small> Contributors: @beliaev-maksim, @tony-meyer, @tmihoc, @james-garner </small>