javierdelapuente | 2024-10-15 19:19:47 UTC | #1

The `go-framework` Charmcraft [extension](/t/15011) includes configuration options customised for a Go application. This document describes all the keys that a user may interact with.
