...
## Contents
<!-- TOC start -->
1. {ref}`Create a juju model <8793md>`
2. {ref}`Deploy Prometheus Charmed Operator <8793md>`
3. {ref}`Deploy COS configuration Charmed Operator <8793md>`
4. {ref}`Relate Prometheus to COS Configuration <8793md>`
5. {ref}`Verification <8793md>`
6. {ref}`Sync interval <8793md>`
7. {ref}`Extra information <8793md>`
<!-- TOC end -->
