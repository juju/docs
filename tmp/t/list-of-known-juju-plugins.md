...
> <small> {ref}`Plugin <plugin>` > List of known Juju plugins</small>
...
- [Official plugins](#heading--official-plugins)
- [Third party plugins](#heading--third-party-plugins)


<a href="#heading--official-plugins"><h2 id="heading--official-plugins">Official plugins</h2></a>

- {ref}``juju-metadata` <plugin-juju-metadata>`
...
<a href="#heading--third-party-plugins"><h2 id="heading--third-party-plugins">Third party plugins</h2></a>
...
* {ref}``juju-stash` <juju-stash>`: stash model names, makes moving between models super simple
