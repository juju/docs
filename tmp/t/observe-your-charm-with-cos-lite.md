...
<!--Since an observability stack such as `COS lite` is usually deployed to its own separate cluster (so it can be shared by all your applications across your various models), as a charm developer you will have to ensure not just that your charm can integrate with all these existing charms but also that it can do so across clouds -- that is, it is ready for cross-model relations. -->

<!-- 
[Prometheus](https://charmhub.io/prometheus-k8s), [Loki](https://charmhub.io/loki-k8s), and [Grafana](https://charmhub.io/grafana-k8s)
-->
...
<!--TODO: Try to make this last paragraph more specific in light of what's happening in this doc.-->

**Contents:**

1. [Integrate with Prometheus](#heading--integrate-with-prometheus)
1. [Integrate with Loki](#heading--integrate-with-loki)
1. [Integrate with Grafana](#heading--integrate-with-grafana)
1. [Specify packages required to build](#heading--build-packages)
1. [Validate your charm](#heading--validate-your-charm)
1. [Review the final code](#heading--review-the-final-code)


<a href="#heading--integrate-with-prometheus"><h2 id="heading--integrate-with-prometheus">Integrate with Prometheus</h2></a>
...
1. [Fetch the Prometheus interface libraries](#heading--fetch-the-prometheus-interface-libraries)
1. [Define the Prometheus relation interface](#heading--define-the-prometheus-relation-interface)
1. [Import the Prometheus interface libraries and set up Prometheus scraping](#heading--import-the-prometheus-interface-libraries-and-set-up-prometheus-scraping)

<a href="#heading--fetch-the-prometheus-interface-libraries"><h3 id="heading--fetch-the-prometheus-interface-libraries">Fetch the Prometheus interface libraries</h3></a>
...
<a href="#heading--define-the-prometheus-relation-interface"><h3 id="heading--define-the-prometheus-relation-interface">Define the Prometheus relation interface</h3></a>
...
> Read more: {ref}``provides` <7814md>`

<a href="#heading--import-the-prometheus-interface-libraries-and-set-up-prometheus-scraping"><h3 id="heading--import-the-prometheus-interface-libraries-and-set-up-prometheus-scraping">Import the Prometheus interface libraries and set up Prometheus scraping</h3></a>
...
<a href="#heading--integrate-with-loki"><h2 id="heading--integrate-with-loki">Integrate with Loki</h2></a>
...
1. [Fetch the Loki interface libraries](#heading--fetch-the-loki-interface-libraries)
1. [Define the Loki relation interface](#heading--define-the-loki-relation-interface)
1. [Import the Loki interface libraries and set up the Loki API](#heading--import-the-loki-interface-libraries-and-set-up-the-loki-api)

<a href="#heading--fetch-the-loki-interface-libraries"><h3 id="heading--fetch-the-loki-interface-libraries">Fetch the Loki interface libraries</h3></a>
...
<a href="#heading--define-the-loki-relation-interface"><h3 id="heading--define-the-loki-relation-interface">Define the Loki relation interface</h3></a>
...
> Read more: {ref}``requires` <7814md>`

<a href="#heading--import-the-loki-interface-libraries-and-set-up-the-loki-api"><h3 id="heading--import-the-loki-interface-libraries-and-set-up-the-loki-api">Import the Loki interface libraries and set up the Loki API</h3></a>
...
<a href="#heading--integrate-with-grafana"><h2 id="heading--integrate-with-grafana">Integrate with Grafana</h2></a>
...
1. [Fetch the Grafana interface libraries](#heading--fetch-the-grafana-interface-libraries)
1. [Define the Grafana relation interface](#heading--define-the-grafana-relation-interface)
1. [Import the Grafana interface libraries and set up the Grafana dashboards](#heading--import-the-grafana-interface-libraries-and-set-up-the-grafana-dashboards)

<a href="#heading--fetch-the-grafana-interface-libraries"><h3 id="heading--fetch-the-grafana-interface-libraries">Fetch the Grafana interface libraries</h3></a>
...
<a href="#heading--define-the-grafana-relation-interface"><h3 id="heading--define-the-grafana-relation-interface">Define the Grafana relation interface</h3></a>
...
<a href="#heading--import-the-grafana-interface-libraries-and-set-up-the-grafana-dashboards"><h3 id="heading--import-the-grafana-interface-libraries-and-set-up-the-grafana-dashboards">Import the Grafana interface libraries and set up the Grafana dashboards</h3></a>
...
<a href="#heading--build-packages"><h2 id="heading--build-packages">Specify packages required to build</h2></a>
...
1. [Deploy COS Lite](#heading--deploy-cos-lite)
1. [Expose the application integration endpoints](#heading--expose-the-application-integration-endpoints)
1. [Integrate your charm with COS Lite](#heading--integrate-your-charm-with-cos-lite)
1. [Access your applications from the host machine](#heading--access-your-applications-from-the-host-machine)
1. [Log in to Grafana](#heading--log-in-to-grafana)
1. [Inspect the dashboards](#heading--inspect-the-dashboards)

<a href="#heading--deploy-cos-lite"><h3 id="heading--deploy-cos-lite">Deploy COS Lite</h3></a>
...
<a href="#heading--expose-the-application-integration-endpoints"><h3 id="heading--expose-the-application-integration-endpoints">Expose the application integration endpoints</h3></a>
...
<a href="#heading--integrate-your-charm-with-cos-lite"><h3 id="heading--integrate-your-charm-with-cos-lite">Integrate your charm with COS Lite</h3></a>
...
<a href="#heading--log-in-to-grafana"><h3 id="heading--log-in-to-grafana">Log in to Grafana</h3></a>
...
<a href="#heading--inspect-the-dashboards"><h3 id="heading--inspect-the-dashboards">Inspect the dashboards</h3></a>
...
![fotor_2023-1-27_20_42_44|690x466](upload://9XqVHeEOxA41mA0f4JVYlsH33VQ.png) 
...
> <small> **Contributors**: @beliaev-maksim, @louiseschmidtgen, @mmkay, @tony-meyer,  @tmihoc </small>