ppasotti | 2024-09-13 04:28:55 UTC | #1

> See also: [Scenario (`scenario`)](/t/10583)
...
import ops
```
> See more: [State (Scenario)](/t/10621).
...
If you wish to use Scenario to test an existing charm type, you will probably need to mock out certain calls that are not covered by the [State](/t/10621) data structure.
