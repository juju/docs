anthonydillon | 2024-03-06 02:00:45 UTC | #1

> See also: [Charmhub | `juju-dashboard`](https://charmhub.io/juju-dashboard), [How to manage the Juju dashboard](/t/5896) 

<!--[The Juju Web CLI](/t/about-the-juju-web-cli/3723)-->
...
If you’ve set up a local controller and this is your first time logging in, make sure you’ve set up a password in Juju with `juju change-user-password [your-username]`
...
The dashboard can be deploy on a controller model using the [juju-dashboard]( https://charmhub.io/juju-dashboard) or [juju-dashboard-k8s]( https://charmhub.io/juju-dashboard-k8s) charm. See the [deployment instructions](https://juju.is/docs/juju/manage-the-juju-dashboard#heading--set-up-the-dashboard) for full details.
