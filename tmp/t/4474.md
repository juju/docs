jnsgruk | 2024-03-07 16:28:54 UTC | #1
...
pedroleaoc | 2022-04-07 08:35:18 UTC | #2



-------------------------

pedroleaoc | 2022-10-14 11:31:42 UTC | #3



-------------------------

danielarndt | 2023-01-26 17:56:43 UTC | #4

[quote="jnsgruk, post:1, topic:4474"]
The Reactive framework also saw the introduction of [layers](https://discourse.charmhub.io/t/layers-for-charm-authoring/1122)
[/quote]

The link here is broken (or perhaps the permissions are not set correctly).

-------------------------

pmatulis | 2023-01-26 19:05:38 UTC | #5

[quote="danielarndt, post:4, topic:4474"]
The link here is broken (or perhaps the permissions are not set correctly).
[/quote]

This points to an archived Discourse topic so it won't be published on the doc site. It should therefore be removed from this current page.

-------------------------

pmatulis | 2023-01-26 19:07:41 UTC | #6

[quote="pmatulis, post:5, topic:4474"]
It should therefore be removed from this current page.
[/quote]

Done. I just removed it.
