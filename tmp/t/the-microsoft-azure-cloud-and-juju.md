...
> <small > {ref}`List of supported clouds <list-of-supported-clouds>` > Microsoft Azure </small>
...
When using the Microsoft Azure cloud with Juju, it is important to keep in mind that it is a (1) {ref}`machine cloud <1086md>` and (2) {ref}`not some other cloud <1086md>`. 

> See more: {ref}`Cloud differences in Juju <1086md>`
...
> See more: {ref}`Appendix: Example authentication workflows  > Workflow 1 <1086md>`
...
> See more: {ref}`Appendix: Example authentication workflows  > Workflows 2-3 <1086md>`
...
> See more: {ref}`Appendix: Example authentication workflows  > Workflow 2 <1086md>`, {ref}`Supported constraints <1086md>`
...
|{ref}``<machine>` <1086md>`|TBA|
|{ref}``subnet=...` <1086md>`|:white_check_mark:|
|{ref}``system-id=...` <1086md>`|&#10060;|
|{ref}``zone=...` <1086md>`|TBA|
