...
1. [Define a peer relation](#heading--define-a-peer-relation)
1. [Set and get data from the peer relation databag](#heading--set-and-get-data-from-the-peer-relation-databag)
1. [Validate your charm](#heading--validate-your-charm)
1. [Review the final code](#heading--review-the-final-code)

<a href="#heading--define-a-peer-relation"><h2 id="heading--define-a-peer-relation">Define a peer relation</h2></a>
...
<a href="#heading--set-and-get-data-from-the-peer-relation-databag"><h2 id="heading--set-and-get-data-from-the-peer-relation-databag">Set and get data from the peer relation databag</h2></a>
...
> <small> **Contributors:** @beliaev-maksim, @mylesjp, @tony-meyer, @tmihoc, @james-garner </small>