tmihoc | 2024-06-14 16:21:03 UTC | #1

> See also: [Secret](/t/7286)
...
[note type=caution]
The write operations are only available (a) starting with Juju 3.3 and (b) to model admin users looking to manage user-owned secrets. See more: [Secret](/t/7286).
[/note]
...
> See more: [`juju add-secret`](/t/11144)
...
> See more: [`juju show-secret`](/t/10172)
...
> See more: [`juju grant-secret`](/t/11290)
...
> See more: [`juju update-secret`](/t/11413)
...
> See more: [`juju remove-secret`](/t/11414)
