...
> See also: {ref}`Cloud <cloud-substrate>`, {ref}`List of supported clouds <list-of-supported-clouds>`

This document shows how to manage your existing cloud(s) with Juju.

## Add a cloud
> See also: {ref}`List of supported clouds > \<cloud name\> > CLOUD <list-of-supported-clouds>`
...
> See more: [`juju add-cloud` <command-juju-add-cloud>`, {ref}`Cloud definition <1100md>`, {ref}``juju` environment variables > `JUJU_DATA` <1100md>`
...
> See more: {ref}``juju add-k8s` <command-juju-add-k8s>`
...
> See more: {ref}`How to add a model <1100md>`
...
> See more: [`juju clouds` <command-juju-clouds>`
...
> See more: [`juju show-cloud` <command-juju-show-cloud>`
...
> See more: [`juju regions` <command-juju-regions>`
...
> See more: {ref}``juju default-region` <command-juju-default-region>`
...
> See: [How to manage credentials <how-to-manage-credentials>`
...
> See more: [`juju update-public-clouds` <command-juju-update-public-clouds>`
...
> See more: [`juju update-cloud` <command-juju-update-cloud>`
...
## Remove a cloud
> See also: [Removing things reference <removing-things>`
...
> See more: {ref}``juju remove-cloud` <command-juju-remove-cloud>`
