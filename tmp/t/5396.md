0x12b | 2024-08-19 11:38:58 UTC | #1
...
> See more: [Charm naming guidelines](/t/5364)
...
erik-lonroth | 2021-11-30 23:40:21 UTC | #2

![image|690x291](upload://iwGC9cMekoivfluvfbT3NUPW9s5.png) 

Broken link?

-------------------------

mthaddon | 2021-12-01 14:52:08 UTC | #3

[quote="0x12b, post:1, topic:5396"]
Do not build strings for the logger
[/quote]
...
mthaddon | 2021-12-01 15:07:45 UTC | #4
...
jose | 2022-05-30 14:53:54 UTC | #6

In some charms we need to get unit's address to share over relation data with other charms.
Getting unit IPs is error prone, since sometimes `bind_address` may return `None`, for instance:
...
0x12b | 2022-06-02 11:00:41 UTC | #7

Thanks José! I've updated the doc to include (a somewhat altered version of) your suggestion.

-------------------------

kian-parvin | 2022-07-26 09:10:25 UTC | #8

![image|690x239](upload://fJRCYGvmVXokxA8ezExNrrl3aCn.png) 

Broken link here?

-------------------------

0x12b | 2022-07-26 09:22:33 UTC | #9

Fixed it. Thank you!

-------------------------

0x12b | 2023-07-06 12:09:34 UTC | #10

Dropped reference to Mypy as it is something that we intentionally decided we don't want to push as an option.

-------------------------

merkata | 2024-08-15 13:48:39 UTC | #11

Under [Unit tests](https://discourse.charmhub.io/t/charm-development-best-practices/5396#heading--unit-tests), the link to testing is broken, maybe it should point here https://juju.is/docs/sdk/get-started-with-charm-testing - it broke when the SDK moved to Diataxis I presume. The link against [module-ops.testing](https://ops.readthedocs.io/en/latest/#module-ops.testing) breaks for me, when I click it, the "/" between `io` and `en` is not there and it tries a bogus .ioen domain..

-------------------------

tmihoc | 2024-08-19 11:38:14 UTC | #12

Fix, thanks! (Added the correct link to `ops.testing`.)
