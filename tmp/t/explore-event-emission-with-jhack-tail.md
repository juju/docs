(explore-event-emission-with-jhack-tail)=
# Explore event emission with `jhack tail`
...
```{note}
 We do this often, reason why there's also [`jhack ffwd`](https://github.com/PietroPasotti/jhack#ffwd) that does that better 😎
```
...
# Pro tip
Did you know about {ref}``jhack fire/replay` <6749md>`? 
