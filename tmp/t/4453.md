simonrichardson | 2023-11-21 15:59:45 UTC | #1
...
arif-ali | 2022-08-04 10:25:41 UTC | #3

Can we be more specific in this doc to suggest that `boot`, `limits` and `migration` are not allowed by default. Having the `-` wasn't totally obvious

-------------------------

pedroleaoc | 2022-10-14 11:30:22 UTC | #4
