...
> See also: {ref}`How to upgrade your Juju deployment from `2.9` to `3.x` <how-to-upgrade-your-deployment>`

In Juju, upgrades can happen at the level of the `juju` CLI client, the controller, the model, the application, and the machine. 

> See more:
> - {ref}`How to upgrade the client <1199md>`
> - {ref}`How to upgrade a controller <1199md>`
> - {ref}`How to upgrade a model <1199md>`
> - {ref}`How to upgrade an application <1199md>`
> - {ref}`How to upgrade a machine <1199md>`
