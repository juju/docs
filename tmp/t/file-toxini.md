...
The `tox.ini` file in your charm’s root directory is a typical Tox configuration file.

> See more: [Tox | Configuration](https://tox.wiki/en/latest/user_guide.html#configuration)
