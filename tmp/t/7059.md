tmihoc | 2024-09-16 15:54:51 UTC | #1
...
addyess | 2024-05-03 18:53:09 UTC | #4

`caas-image-repo` says it's modifiable after bootstrap, but it's not really according to [this discussion](https://matrix.to/#/!xzmWHtGpPfVCXKivIh:ubuntu.com/$F82kSS0Uy_l7Ju3S5f8KFBGr2JCqJpjqLFZqxz0d-9I?via=ubuntu.com&via=matrix.org&via=fsfe.org)

Please update the docs to indicate it cannot be changed after bootstrap
