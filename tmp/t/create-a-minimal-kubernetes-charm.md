...
> Read more: {ref}``containers` <7388md>`
...
> Read more: {ref}``resources` <7388md>`
...
> Read more: {ref}`File `requirements.txt` <file-requirementstxt>`
...
> Read more: {ref}``src/charm.py` <file-srccharmpy>`
...
> Read more:  {ref}``<container>-pebble-ready` <event-container-pebble-ready>`
...
> Read more: [How to configure a Pebble layer <7388md>`
...
> Read more: {ref}``juju debug-log` <how-to-manage-logs>`
