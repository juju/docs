...
For example, in `vim` you could execute the command:
...
- A general [comparison of American and British English](https://en.wikipedia.org/wiki/Comparison_of_American_and_British_English)
- A list of [American and British spelling differences](https://en.wikipedia.org/wiki/American_and_British_English_spelling_differences)
